...
public class ReplicationTransmitter implements ChannelSender {
     ...
     * @see ChannelSender#sendMessage(ChannelMessage, Member[])
     */
    @Override
     ...
     *
     * @see ChannelSender#remove(Member)
     */
    @Override
